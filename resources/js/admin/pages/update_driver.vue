                ...
                <div class="row justify-content-center">
                  ...
                  <option value="" > Select Driver Name Here </option>
                    ...
                    :key="driver.id"   >{{driver.staff_name}}</option>
                                    ...
                                    <div class="col-12">
                                        <router-link :to="{name:'admin.order'}" class="float-left">
                                            <button class="btn btn-secondary mt-0">
                                                <i class="fa fa-arrow-left"></i> Back
                                            </button>
                                        </router-link>
                                        <button class="btn btn-info mt-0 float-right" @click.prevent="update">
        ...
        update(id) {
            let $this = this;
             ...
             if (!this.errors.length) {
                    ...
                    post(BASE_URL + `/api/order/${this.id}/driver`, form).then(function (response) {
                        if (response.data) {
