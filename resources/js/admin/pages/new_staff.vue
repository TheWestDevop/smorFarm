                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                        <form v-on:submit.prevent="onCreate">
                            <div class="login-form">
                                <h2 class="login-name text-center ">New Staff </h2>
                                <div class="row">
...
export default {
    ...
    methods: {
        onCreate() {
            ...
            if (!this.img) {
                this.errorImage = "Staff Image is required";
            ...
            if (!this.errors.length) {
                ...
                let data = form
                post(BASE_URL + "/api/staff/new", data).then(function (response) {
                    ...
                    if (response.data.message) {
                     ...
                     this.$toast.success('New Staff Account Created', {
                                position: 'top-center',
                                timeout: 1000,
                                closeOnClick: true,
