...
<div class="page-section mb-60">
     <br>
        <div class="container">
<div class="ct-page-title h2">All User Pre-Orders</div>
 <div class="table-responsive">
                     <table class="table table-striped  table-darker">
                         ...
                         <tbody>
                             <tr v-for="order in this.$store.getters.ALL_USER_PRE_ORDER.data" :key="order.id">
                                 <td>
                                    <div class=" d-flex ">
                                 ...
                                 <td>{{order.date_to_deliver | dayjs('daysInMonth') }}</td>
                     ...
                     <pagination :paginations="this.$store.getters.ALL_USER_PRE_ORDER.pagination" @paginate="navigate" :offset="4">
                            </pagination>
 </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        navigate(){
            this.$store.dispatch('fetchAllUserPreOrder',this.$store.state.UserModule.user.user.id);
        }
