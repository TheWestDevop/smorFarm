    ...
    methods: {
        makeOrder() {
            ...
            if (!this.errors.length) {
                if (this.$store.getters.CART == null || this.$store.getters.CART.length === 0) {
                    ...
                    if ($this.$store.getters.IS_PREORDER === false) {
                        if (this.$store.getters.AUTH_STATUS === false) {
                            if ($this.$store.getters.FAST_USER === [] || $this.$store.getters.FAST_USER === null) {
                            ...
                            $this.$store
                        ...
                        } else if (this.$store.getters.AUTH_STATUS === true) {
                                ...
                                let message = `Your Order is on the way,Will be deliver as soon as possible`;
                                $this.$store.dispatch("set_notification", message)
                                $this.$store.dispatch("get_notification")

                        } else {
                            this.errorOrder = "Authentication ";
                        ...
                        $this.$store
                            .dispatch("userPreOrder")
                            .then(() => {
                          $this.$store.dispatch("spinner",false);
                                this.$router.push({
                                    name: "payment_success"
                                });
                                $this.$toast.success(`Your Pre Order Is Saved`, {
                                    position: 'bottom-center',
                                    timeout: 10000,
                                    closeOnClick: true,
                                    pauseOnFocusLoss: true,
                        ...
                        let message = `Your Pre Order Has Been Saved, Will Be Deliver At Date And Time Specified  `;
                        $this.$store.dispatch("set_notification", message)
                        $this.$store.dispatch("get_notification")
                    }
